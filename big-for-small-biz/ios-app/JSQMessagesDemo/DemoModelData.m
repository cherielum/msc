...
- (instancetype)init
{
    ...
    if (self) {
        ...
        JSQMessagesAvatarImage *jsqImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"person"]];
        
        JSQMessagesAvatarImage *cookImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"bot"]];
        
        JSQMessagesAvatarImage *jobsImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"bot"]];
        
        JSQMessagesAvatarImage *wozImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"bot"]];
    ...
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdWoz
                                        senderDisplayName:kJSQDemoAvatarDisplayNameWoz
                                                     ...
                                                     text:NSLocalizedString(@"Welcome to MainStreetChat: AI Chatbot for managing your small business.", nil)],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdWoz
                                        senderDisplayName:kJSQDemoAvatarDisplayNameWoz
                                                     date:[NSDate distantPast]
                                                     text:NSLocalizedString(@"It is simple, elegant, and easy to use.", nil)],
