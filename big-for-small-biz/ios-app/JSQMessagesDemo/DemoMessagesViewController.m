                      ...
                      date:(NSDate *)date
{
    ...
    [self postMessageWithMessage:message completion:^(BotMessage * botMessage) {

        JSQMessage *newBotMessage = [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdCook
